...
{
    [CreateAssetMenu(
        menuName = "Chaosbound/Items/Expedition Reward Item Database",
        fileName = "ExpeditionRewardItemDatabase")]
    public sealed class ExpeditionRewardItemDatabase : ScriptableObject
    {
        [SerializeField]
        ...
        private void BuildLookupIfNeeded()
        {
            ...
            for (int i = 0; i < items.Count; i++)
            {
                ...
                {
                    Debug.LogError(
                        $"Duplicate Expedition Reward Item ContentId " +
                        $"'{contentId}' found in database '{name}'.",
                        this);
